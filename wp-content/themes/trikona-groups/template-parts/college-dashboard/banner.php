<?php if($_GET['collegeData']=="true" && $_GET['tab']=='college-banner' || (isset($_GET['groupId']) && $_GET['tab']=='college-banner')){
    $obj = new Trikona();
   ...
   var attach_ids=  jQuery(this).attr('attach_ids');
    jQuery.ajax({
        ...
        success: function(data)
        {
         ...
         // window.location.href = "/college-dashboard/?collegeData=true&&tab=college-banner";
