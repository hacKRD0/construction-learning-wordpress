...
<section class="top-sec" style="padding:20px;">
<div class="container">
    ...
    <div class="col-sm-2">
      ...
      <div class="col-sm-9" style="margin:0px 30px;">
          <h2 style="text-transform: uppercase;">'.$fname.' '. $lname.'</h2>
          <h5 style="color:#1e3f66;">'.$designation_current.'</h5>
          <p style="margin-right:30px; text-align: justify;">'.$member_bio.'</p>  
      </div>
...
<section class="top-second-sec" style="background-color: #1e3f66; color:#fff; padding: 5px 10px;">
<div class="container">
    <div class="row" style="width: 90%;">
      ...
      <div class="icon-box"> <span class="fa fa-phone"> </span><span style="padding-left:10px;color:#fff;">'. $phone .'</span></div>  
      </div>
    </div>
    <div class="row" style="width: 95%; padding:5px 0px;">
    <div class="col-sm-6">
