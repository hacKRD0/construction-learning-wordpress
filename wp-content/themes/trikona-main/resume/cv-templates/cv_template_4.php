...
<div class="container-lg resume-container template-type-4">
	<div class="row">
		...
		<div class="col-md-9 mb-auto mt-auto offset-md-1">
			...
			<?php
				if(!empty($current_position)){
					echo "<h4>".esc_html( implode(", ", $current_position) )."</h4>";
				}
				if (!empty($member_bio)) {
				...
				<div class="experience-info-container pt-4">
					<ul>
						...
						?>
							<?php /*if($rowid == 1){ ?>
								<li>
									Working at <b><?php echo $experiences->organization;  ?></b> as a <?php echo $experiences->position; ?> since <?php echo $experiences->fromdate; ?>
									<?php if(!empty($experiences->responsibility)){ echo "<p>".esc_html( $experiences->responsibility )."</p>"; } ?>
								</li>
							<?php } else {*/ ?>
								<li>
