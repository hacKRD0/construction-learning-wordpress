...
<div class="container py-4 resume-container">
  ...
  <!-- Header Section -->
  <div class="row bg-white p-4 shadow-bottom rounded mb-4 align-items-center">
  ...
  <!-- About Me -->
  <div class="bg-white p-4 shadow-bottom rounded mb-4 section">
  ...
  <div class="bg-white p-4 shadow-bottom rounded mb-4 section">
    ...
    <div class="mb-3">
      ...
      <div class="progress">
        <div class="progress-bar <?= $progress_class ?>" role="progressbar" style="width: <?= $percentage ?>%"><?= $percentage ?>%</div>
      </div>
    </div>
    <?php } ?>
  </div>
